...
public class MainActivity extends AppCompatActivity {
    ...
    // 直播信号
    private String hksUrl = "http://live.hkstv.hk.lxdns.com/live/hks/playlist.m3u8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        controller.setTitle("香港卫视直播");
//        controller.setLenght(888);
        Glide.with(this)
        ...
        controller.setDataSource(hksUrl);
        ...
        mp4Controller.setDataSource(mp4Url);
    }
